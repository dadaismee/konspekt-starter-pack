...
- Плагины — сторонние расширения, которые добавляют функции (например, импорт ваших заметок из Zotero [сделать активную ссылку на зотеро]).
