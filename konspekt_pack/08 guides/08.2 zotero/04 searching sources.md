# Поиск и добавле источников (Google Scholar, Research Rabbit)
...
3. **Добавьте первый источник**
	...
	* **Импорт из Zotero**
		1. Нажмите кнопку **"Iort Zotero Collection"**.
		2. Войдите в свою учёузапись Zotero, когда появится запрос.
		3. Разрешите доступ и выберите нужную коллекцию исписка.
		4. Источники появятся в вашем ResearchRabbit-проекте и будут отражаться как граф.
	* **Импорт из BibTeX**
		*Если у вас есть `.bib`\-файл (эксрт из Zotero, Mendeley и т.д.):*
