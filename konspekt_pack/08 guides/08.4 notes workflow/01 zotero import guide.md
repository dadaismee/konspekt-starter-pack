...
5. Начните писать название команды и выберите её:  
    `QuickAdd: Literature notes`
6. Введите название источника (или несколько)  
...
8. Появится готовая литературная заметка  
...
9. Заполните шаблон
	...
	– Связанные заметки
10. Разбейте её на перманентные заметки
11. Выделите и скопируйте идею подходящую для перманентной заметки
12. Командой `ctrl+n` создайте Перманентную заметку
13. Вставьте скопированную идею в шаблон заметки и обработайте её
	Подробнее про перманентные заметки в части гайда про Перманентные заметки
14. После того, как обработаете все идеи – перенесите Литературную заметку в папку с литературными заметками  
